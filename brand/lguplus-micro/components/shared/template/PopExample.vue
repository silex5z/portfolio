<!-- NOTICE :: 기본팝업. 복사 후 변경해서 사용하세요.
              주석 및 필요없는 코드는 지워서 사용해주세요. -->
<template>
  <div>
    <!-- NOTICE :: type종류 empty:빈팝업 -->
    <PopBase v-show="isShow" :show="isShow" :className="'example'">
      <!-- NOTICE :: 기본틀가지고 있는 팝업 사용 예시 -->
      <template #header>
        변경할 내용
      </template>
      <template #content>
      ...
      <!-- NOTICE :: 닫기버튼 custom 사용 예시. 기본 닫기 실행 시킬 때는 안쓰셔도 됩니다. -->
...
export default {
  ...
  methods: { ...mapActions('popup', ['openPop', 'closePop']) }
}
</script>
