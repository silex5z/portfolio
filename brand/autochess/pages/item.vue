<template>
  <div class="wrapper">
    <nav-top-menu :activeName="ITEM" />

    <TopVisual :bgClassName="'item'" />
      ...
      <template>
        ...
        <div class="main__inner">
          <div class="main__inner--left">
            ...
            <Expansion-Button :info="ratingInfo" />

            <Expansion-Square-Img-Button :info="jobInfo" />
          </div>
...
<script>
import { ITEM } from '@/components/const/PageName'
...
import ExpansionSquareImgButton from '@/components/button/ExpansionSquareImg'
