<template>
  <div class="wrapper">
    <nav-top-menu :activeName="ACP" />

    <TopVisual :bgClassName="'acp'" />

    <main class="main">
      <template>
        <h2 class="title">ACP</h2>

        <div class="main__inner">
          <div class="main__inner--left">
            <Expansion-Button :info="acpInfo" />
          </div>
...
<script>
import { ACP } from '@/components/const/PageName'
...
import AcpTable from '@/components/table/Acp'
